...
def main(args, config):
    ...
    for epoch in range(start_epoch, max_epoch):
        ...
        # elif (config['selective_sampling'] and data_loader.shuffle) or (not config['selective_sampling'] and not data_loader.shuffle):
        #     print("Incorrect combination of parameters: selective_sampling and shuffle cannot be\
        #         true/false at the same time, will lead to erroneous behavior.")
