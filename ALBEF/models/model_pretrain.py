...
class ALBEF(nn.Module):
    def __init__(self,                 
        ...
        if init_deit:
            #checkpoint = torch.hub.load('facebookresearch/deit:main', 'deit_base_patch16_224', pretrained=True)
            checkpoint = torch.hub.load_state_dict_from_url(
               url="http://dl.fbaipublicfiles.com/deit/deit_base_patch16_224-b5f2ef4d.pth",
               map_location="cpu") 
            # checkpoint = torch.load('pretrained_models/deit_base_patch16_224-b5f2ef4d.pth')
            # print(checkpoint)
        ...
        # self.text_encoder = BertForMaskedLM.from_pretrained("http://huggingface.co/bert-base-uncased/blob/main/", config=bert_config)     
        ...
        # self.text_encoder_m = BertForMaskedLM.from_pretrained("http://huggingface.co/bert-base-uncased/blob/main/", config=bert_config)    
