...
class MedCLIPModel(nn.Module):
    ...
    def forward(self,
        ...
        **kwargs,
        ...
        # print(f"Shapes for input_ids:{input_ids.shape}, pixel_values:{pixel_values.shape},\
        #  img_embeds:{img_embeds.shape}, text_embeds:{text_embeds.shape}, logits_per_image:{logits_per_image.shape}\
        #  logits_per_text:{logits_per_text.shape}   ")
