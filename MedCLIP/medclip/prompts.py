...
def generate_uwmadison_class_prompts(n = None):
    """Generate text prompts for each UW-madison classification task
    Parameters
    ----------
    n:  int
    ...
    prompts = {}
    for k, v in constants.UWMADISON_CLASS_PROMPTS.items():
        cls_prompts = []
        keys = list(v.keys())
