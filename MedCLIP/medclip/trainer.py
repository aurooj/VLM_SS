...
class Trainer:
    ...
    def train(self,
        ...
        print(f"num_train_objectives:{num_train_objectives}")
        ...
        for epoch in trange(epochs, desc="Epoch", disable=not show_progress_bar):
            ...
            if selective_sampling:
                ...
                for dataloader in dataloaders:
                    if shuffle_all:
                        dataloader.dataset.shuffle_all(bs=dataloader.batch_size)
                    else:
                        dataloader.dataset.shuffle(bs=dataloader.batch_size, 
                                                rare_grp_ratio=rare_grp_ratio,
            ...
            #  data_iterators = [iter(dataloader.dataset.shuffle(bs=dataloader.batch_size)) for dataloader in dataloaders]
            # dataloaders[0].dataset.shuffle(bs=dataloaders[0].batch_size)
